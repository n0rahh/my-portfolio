<template>
  ...
  >
    <!-- <v-row class="pa-0 ma-0">
      <v-col xl="5" lg="6" cols="12" class="d-flex flex-column">
        <span
          :class="{
        ...
        <p v-for="(technology, index) in projectInfo.usedTechnologies" :key="index" class="p1 mt-6">
      ...
      >
        ...
        >
          <v-dialog :key="dialogKey" v-model="imageModal" max-width="80%">
            <template #activator>
              <div
            ...
            <div class="mt-2 navigation d-flex justify-space-around">
              <v-btn
                ...
                @click="prevImage"
              >
                <v-icon size="x-large" icon="mdi-arrow-left-thick" class="mr-4" />
              ...
              >
                ...
                <v-icon size="x-large" icon="mdi-arrow-right-thick" class="ml-4" />
              </v-btn>
            </div>
          </v-dialog>
        </div>
    ...
    methods: {
      fetchProject() {
        ...
        const updateDescriptions = () => {
          project.longDescription = i18n.global.t(
            `PROJECTS.${project.longDescriptionValue}.DESCRIPTION`
          );
      ...
      sourceCodeText(url) {
        return url !== ""
          ? this.$t("PROJECTS.SOURCE_CODE_AVAILABLE")
          : this.$t("PROJECTS.SOURCE_CODE_UNAVAILABLE");
      },
      ...
      prevImage() {
        ...
        this.currentImageIndex =
          (this.currentImageIndex - 1 + this.projectInfo.images.length) %
          this.projectInfo.images.length;
      },
    },
  };
</script> -->
